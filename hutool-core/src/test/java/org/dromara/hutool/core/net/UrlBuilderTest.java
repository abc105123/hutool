...
public class UrlBuilderTest {
	...
	public void getAuthorityTest() {
		...
		assertEquals("127.0.0.1:8080", builder.getAuthority());
	}
	...
	public void ofHttpTest() {
		...
		assertEquals("http://hutool.cn", ofHttp.toString());

		ofHttp = UrlBuilder.ofHttp("https://hutool.cn");
		assertEquals("https://hutool.cn", ofHttp.toString());

		ofHttp = UrlBuilder.ofHttp("hutool.cn");
		assertEquals("http://hutool.cn", ofHttp.toString());

		ofHttp = UrlBuilder.ofHttp("hutool.cn?old=http://aaa");
		assertEquals("http://hutool.cn?old=http://aaa", ofHttp.toString());
	}
	...
	public void pathWithColonTest() {
		...
		final UrlPath httpUrl = UrlPath.of("/a:1/b:1/c:1/d:1/", CharsetUtil.UTF_8);
